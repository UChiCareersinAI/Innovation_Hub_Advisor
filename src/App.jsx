            ...
            <div style={{flex:1,overflowY:"auto",padding:"40px",display:"flex",justifyContent:"center"}}>
              <div style={{maxWidth:"560px"}}>
                ...
                <div style={{marginBottom:"16px"}}>
                  <div style={{...styles.sidebarLabel, marginBottom:"0px"}}>Include in Newsletter *</div>
                  <div style={{fontSize:"12px",fontStyle:"italic",color:"#555",marginTop:"0px",marginBottom:"2px"}}>Should this resource be sent in Thursday's Newsletter? If it's a cool tool/resource but not necessarily relevant for Thursday's newsletter, select 'None/Hold' and it will still be available for advising notes.</div>
                ...
                <div style={{marginBottom:"16px"}}>
                  <div style={{...styles.sidebarLabel, marginBottom:"0px"}}>URL or Contact Info *</div>
                  <div style={{fontSize:"12px",fontStyle:"italic",color:"#555",marginTop:"0px",marginBottom:"2px"}}>Use 'Preview Link' for Handshake resources!</div>
